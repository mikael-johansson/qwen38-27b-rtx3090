...
| [docs/mamba-align-prefill-leak.md](docs/mamba-align-prefill-leak.md) | Root cause of large-prompt self-preemption: a real vLLM bug in `mamba-cache-mode align`'s block freeing. Current mitigation is a config change; the actual fix is still open. |
