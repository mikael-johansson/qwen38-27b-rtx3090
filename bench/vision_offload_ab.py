#!/usr/bin/env python3
"""A/B the cost of CPU-offloading the ViT tower (VLLM_VISION_CPU_OFFLOAD_GB).
...
Run it once with VLLM_VISION_CPU_OFFLOAD_GB unset/0 (weights in VRAM) and once
with it set (weights in pinned host RAM, read over PCIe via UVA), and compare
the medians.
